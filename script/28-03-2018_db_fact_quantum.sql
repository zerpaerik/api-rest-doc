...
INSERT INTO `branch_office` (`id`, `name`, `phone`, `address`, `email`, `emission_point`, `company_id`, `is_active`, `is_deleted`) VALUES
	(1, 'Quantum Branch', '+59387654321', 'Ecuador', 'branch@quantum.com', 2, 1, 1, 0);
...
INSERT INTO `client` (`id`, `social_reason`, `comercial_name`, `phone`, `address`, `email`, `company_id`, `is_active`, `is_deleted`) VALUES
	(1, 'Cardenas', 'Tonny', NULL, '1773 Crossfields Rd', NULL, 1, 0, 1),
	(2, 'TONNY', 'CARDENAS', NULL, '1773 Crossfields Rd', 'cardenat@gmail.com', 1, 0, 1),
	(3, 'Cliente 3', 'Cliente 3 comercial', '7866017730', 'Valencia, Valencia', 'cardenat@gmail.com', 1, 1, 0),
	(4, 'TONNY', 'CARDENAS', NULL, '1773 Crossfields Rd', 'cardenat@gmail.com', 1, 1, 0);
...
INSERT INTO `company` (`id`, `name`, `comercial_name`, `emission_code`, `tax_year`, `url`, `phone`, `address`, `email`, `is_accounting`, `is_active`, `is_deleted`) VALUES
	(1, 'Quantum', 'Quantum Ecuador', 1, 10118, 'http://quantum.com', '+59312345678', 'Ecuador', 'test@quantum.com', 1, 1, NULL);
...
-- Volcando datos para la tabla db_fact_quantum.entity_masterdata: ~14 rows (aproximadamente)
...
INSERT INTO `entity_masterdata` (`id`, `code`, `name`, `description`, `field`, `is_active`, `entity_id`, `is_deleted`) VALUES
	(1, '1', 'Efectivo', 'Efectivo', NULL, 0, 1, 1),
	(2, '2', 'Debito', 'Tarjeta de Debito', NULL, 1, 1, 0),
	(3, '3', 'Crédito', 'Tarjeta de Crédito', NULL, 0, 1, 0),
...
CREATE TABLE IF NOT EXISTS `invoice` (
  ...
  `total_ice` decimal(15,4) DEFAULT NULL,
  `total_iva` decimal(15,4) DEFAULT NULL,
  `total_invoice` decimal(15,4) DEFAULT NULL,
  `xml_generated` blob,
...
INSERT INTO `product` (`id`, `name`, `principal_code`, `auxiliary_code`, `description`, `unit_price`, `unit_cost`, `is_purchase_active`, `is_sale_active`, `min_stock`, `max_stock`, `company_id`, `is_active`, `is_deleted`) VALUES
	(1, 'Producto A', '123456789-0', NULL, 'Producto A', 100.0000, 50.0000, 1, 1, 100.0000, 150.0000, 1, 1, 0),
	(2, 'Producto B', '123456789-1', NULL, 'Producto A', 100.0000, 50.0000, 1, 0, 100.0000, 50.0000, 1, 1, 0),
	(3, 'Producto A', '123456789-0', NULL, NULL, 100.0000, 50.0000, 1, 1, 100.0000, 150.0000, 1, 1, 0);
