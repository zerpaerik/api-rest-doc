...
INSERT INTO `branch_office` (`id`, `name`, `phone`, `adress`, `email`, `emission_point`, `company_id`, `is_active`, `is_deleted`) VALUES
...
INSERT INTO `client` (`id`, `social_reason`, `comercial_name`, `phone`, `address`, `email`, `company_id`, `is_active`, `is_deleted`) VALUES
	...
	(3, 'Cliente 3', 'Cliente Test comercial', '7866017730', 'Valencia, Valencia', 'cardenat@gmail.com', 1, 1, 0),
...
-- Volcando datos para la tabla db_fact_quantum.entity_masterdata: ~15 rows (aproximadamente)
